...
Version  : 1.0.0
Release  : 44
URL      : https://cran.r-project.org/src/contrib/gower_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/gower_1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643908932
