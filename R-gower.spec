...
Version  : 1.0.2
Release  : 57
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/gower_1.0.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/gower_1.0.2.tar.gz
...
%setup -q -n gower
pushd ..
cp -a gower buildavx2
popd
pushd ..
cp -a gower buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735107360
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/gower/libs/gower.so
/V4/usr/lib64/R/library/gower/libs/gower.so
